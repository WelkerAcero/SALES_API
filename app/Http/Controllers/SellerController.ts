...
export class SellerController extends SellerModel {
    getSellers = async (req: Request, res: Response): Promise<Response> => {
        try {
    ...
    storeSeller = async (req: Request, res: Response): Promise<any> => {
        try {
